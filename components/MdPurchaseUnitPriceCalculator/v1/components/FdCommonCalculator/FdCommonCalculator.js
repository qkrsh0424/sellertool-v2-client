                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr style={{ background: 'var(--mainColorOpacity100)' }}>
                                        ...
                                        <td style={{ fontWeight: '700', color: 'var(--mainColor)' }}>1,000,000원</td>
                                        <td style={{ fontWeight: '700', color: 'var(--mainColor)' }}>100,000원</td>
                                        <td>200,000원</td>
                                        <td>100개</td>
                                    </tr>
                                </tbody>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr style={{ background: 'var(--mainColorOpacity100)' }}>
                                        ...
                                        <td style={{ fontWeight: '700', color: 'var(--mainColor)' }}>50개</td>
                                        <td style={{ fontWeight: '700', color: 'var(--mainColor)' }}>2,000,000원</td>
                                        <td style={{ fontWeight: '700', color: 'var(--mainColor)' }}>100,000원</td>
                                    </tr>
                                    <tr>
                                        <td>C 제품</td>
