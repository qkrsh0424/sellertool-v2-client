...
export default function Days60Button({
    callback,
    selectedDate,
    ...props
}) {
    const handleClickButton = () => {
        ...
        let searchDate = getStartDate(setPlusDate(currDateTime, 0, 0, -59)) ;
    ...
    return (
        <ButtonItem
            ...
            checked={dateToYYYYMMDD(selectedDate) ===  dateToYYYYMMDD(setPlusDate(new Date(), 0, 0, -59))}
            {...props}
        >
            60일
        </ButtonItem>
