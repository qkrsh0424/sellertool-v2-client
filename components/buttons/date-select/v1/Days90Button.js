...
export default function Days90Button({
    callback,
    selectedDate,
    ...props
}) {
    const handleClickButton = () => {
        ...
        let searchDate = getStartDate(setPlusDate(currDateTime, 0, 0, -79));
    ...
    return (
        <ButtonItem
            ...
            checked={dateToYYYYMMDD(selectedDate) === dateToYYYYMMDD(setPlusDate(new Date(), 0, 0, -79))}
            {...props}
        >
            90일
        </ButtonItem>
