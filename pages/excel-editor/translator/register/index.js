...
import MainComponent from "../../../../views/excel-editor/translator/register";

export default function ExcelEditor_Translator_Register_Page(props) {
    ...
    return (
        <>
            <Head>
                <title>엑셀 변환기 등록 | 셀러툴 - 쇼핑몰 통합관리</title>
            </Head>
