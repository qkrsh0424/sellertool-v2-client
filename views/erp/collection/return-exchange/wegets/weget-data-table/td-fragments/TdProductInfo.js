...
export function TdProductInfo({
    ...
    const releaseProductOptionData = returnExchangeValueHook.productOptions?.find(productOption => productOption.code === returnExchange?.releaseOptionCode);
            ...
            returnExchangeActionsHook.returnExchangesActions.setValue(prev => {
                return prev.map(prevItem => {
                    ...
                    if (newItem) {
                        return {
                            ...prevItem,
                            releaseOptionCode: newItem?.releaseOptionCode,
                            unit: newItem?.unit,
                        };
                    } else {
                        return prevItem;
    ...
    const handleClickOpenEditMode = (e) => {
        ...
        setInputValues({
            releaseOptionCode: returnExchange?.releaseOptionCode,
            unit: returnExchange?.unit
        });
    }
                ...
                <div>
                    {releaseProductOptionData ?
                        <>
                            ...
                            <div>
                                <ClickableSpan onClick={(e) => handleClickOpenEditMode(e)}>{returnExchange?.unit}개</ClickableSpan>
                            </div>
                        </>
                        :
                        <div>
                    ...
                    <form onSubmit={(e) => handleSubmit(e)}>
                        <EditBox>
                            ...
                            <div className='inputBox'>
                                ...
                                <div>
                                    <input type="number" name='unit' value={inputValues?.unit || ''} onChange={(e) => handleChangeInputValues(e)} autoFocus />
                                </div>
                            </div>
                ...
                <CustomSearchOptionCodesModal
                    ...
                    onSelect={(code, productOptionData) => {
                        ...
                        setInputValues(prev => {
                            return {
                                ...prev,
                                releaseOptionCode: productOptionData?.code
                            }
                        });
