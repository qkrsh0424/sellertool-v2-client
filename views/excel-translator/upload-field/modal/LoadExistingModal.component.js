                ...
                <div className='content-group'>
                    {excelTranslatorHeaders?.map(r => {
                        return (
                            ...
                            >
                                <div>
                                    [ {r.uploadHeaderTitle} &gt; {r.downloadHeaderTitle} ] 의 <span style={{ color: 'var(--mainColor)', fontWeight: '600' }}>{r.uploadHeaderTitle}</span>
                                </div>
                                <div className='header-count'>
                                    헤더 개수: {r.uploadHeaderDetail?.details ? r.uploadHeaderDetail?.details?.length : 0}
                                </div>
                            </div>
                        );
                    })}
