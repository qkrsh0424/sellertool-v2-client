...
import { Container, ContentContainer, SubmitButtonContainer } from "../styles/BatchReceiveMemoModal.styled";

export default function BatchReceiveMemoModalComponent({
    onClose,
    onConfirm
}) {
