...
import { Container, ContentContainer, SubmitButtonContainer } from "../styles/BatchReleaseUnitModal.styled";

export default function BatchReleaseUnitModalComponent({
    onClose,
    onConfirm
}) {
    ...
    const handleSubmit = (e) => {
        ...
        if (!inputValue || inputValue < 1 || inputValue > 1000) {
            alert('출고수량은 1-1000 이내의 숫자만 입력 가능합니다.');
            return;
        }
