...
export function FdItemList() {
    ...
    useEffect(() => {
        ...
        async function initialize() {
            ...
            fetchProductOptionPageParams.productCategoryId = routerSearchAggregationHook?.productCategoryId;
            fetchProductOptionPageParams.productSubCategoryId = routerSearchAggregationHook?.productSubCategoryId;
            fetchProductOptionPageParams.page = routerSearchAggregationHook?.page;
            fetchProductOptionPageParams.size = routerSearchAggregationHook?.size;
            fetchProductOptionPageParams.searchFilter = routerSearchAggregationHook?.searchFilter;
            fetchProductOptionPageParams.sortTypes = routerSearchAggregationHook?.sortTypes || routerSearchAggregationHook.DEFAULT_SORT_TYPES;

            await _apiHook.onReqFetchProductOptionPage({
                params: fetchProductOptionPageParams, headers: { wsId: wsId }
            },
                (results, response) => {
