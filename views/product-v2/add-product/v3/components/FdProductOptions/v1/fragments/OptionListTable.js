                        ...
                        <tr>
                            ...
                            {OPTION_HEADER?.map((r, index) => {
                                return (
                                    ...
                                    >
                                        <div className='mgl-flex mgl-flex-justifyContent-center mgl-flex-alignItems-center' style={{ gap: '5px' }}>
                                            {r.required &&
                                            ...
                                            {r.name === 'code' &&
                                                <>
                                                    <ClipboardPlus size={16} style={{ cursor: 'pointer' }} onClick={() => onGenerateNewOptionCode()} />
                                                </>
                                            }
