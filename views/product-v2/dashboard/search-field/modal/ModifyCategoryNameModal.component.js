...
import { Container } from "../styles/ModifyCategoryNameModal.styled";

export default function ModifyCategoryNameModalComponent({
    productCategory,
    onClose,
    onConfirm
}) {
    ...
    const __handle = {
        submit: {
            confirm: (e) => {
                e.preventDefault();
                setDisabledBtn(true);
                let originName = productCategory.name;
    ...
    return (
        <>
            <Container>
                ...
                >
                    <div className='title'>
                        카테고리명을 <span style={{ color: 'var(--mainColor)' }}>수정</span>합니다.
                    </div>
                </div>
