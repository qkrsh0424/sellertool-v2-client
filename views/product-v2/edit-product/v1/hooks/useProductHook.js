...
export default function useProductHook({
    ...
    const getSubmitValue = () => {
        ...
        newData = {
            ...
            productTag: newData.productTag ? newData.productTag.trim() : '',
            thumbnailUri: newData.thumbnailUri ? newData.thumbnailUri.trim() : '',
            purchaseUri: newData.purchaseUri ? newData.purchaseUri.trim() : '',
            memo: newData.memo ? newData.memo.trim() : '',
        }
